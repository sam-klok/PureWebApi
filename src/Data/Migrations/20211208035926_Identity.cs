    ...
    public partial class Identity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Gifts",
                columns: new[] { "GiftID", "Name" },
                values: new object[] { 1, "Sneakers" });

            migrationBuilder.InsertData(
                table: "Gifts",
                columns: new[] { "GiftID", "Name" },
                values: new object[] { 2, "Bottle of juice" });

            migrationBuilder.InsertData(
                table: "Location",
                columns: new[] { "LocationId", "Address1", "Address2", "Address3", "CityTown", "Country", "PostalCode", "StateProvince", "VenueName" },
                values: new object[] { 2, "2000 Van Buren Street", null, null, "Phoenix", "USA", "85286", "AZ", "Phoenix Convention Center" });

            migrationBuilder.InsertData(
                table: "Camps",
                columns: new[] { "CampId", "EventDate", "Length", "LocationId", "Moniker", "Name" },
                values: new object[] { 2, new DateTime(2021, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 2, "PHX2021", "Arizona Code Camp" });
